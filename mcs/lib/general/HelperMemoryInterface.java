...
public interface HelperMemoryInterface {
	...
	public String generateStaticRead(int dep, int taille);
	 ...
	 /**
	  * code pour ecrire la valeur d'une expression dont on connait l'adresse à la compilation : variable, champ d'un struct etc
	  * @param dep
	  * @param taille
	  * @return
	  */
	...
	/**
	 * code pour lire la valeur d'une expression dont on connait l'adresse à l'execution seulement : pointeurs
	 * @param taille
	 * @return
	 */
	...
	/**
	 * code pour ecrire la valeur d'une expression dont on connait l'adresse à l'execution seulement : pointeurs
	 * @param taille
	 * @return
	 */
